...
function MversionKiosk() {
  ...
  return (
    <div className='container-fluid m-main mt-5 mb-5'>
      ...
      <p className='mo-kispara'>We provide custom kiosk software development for our customer’s current and future needs. Our kiosk & touchscreen development team builds efficient UIs, multi-tenant services, hardware interfaces, branding management, resource management, and remote administration.</p>
